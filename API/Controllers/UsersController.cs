...
namespace API.Controllers
{
	...
	public class UsersController : BaseApiController
	{
		...
		public async Task<ActionResult<IEnumerable<MemberDto>>> GetUsers([FromQuery]UserParams userParams)
		{
			...
			{
				userParams.Gender = await _unitOfWork.UserRepository.GetUserGender(userParams.CurrentUsername) == "male" ? "female" : "male";
			}
		...
		{
			return await _unitOfWork.UserRepository.GetMemberUsernameAsync(username);
		}
		[HttpPut]
